<%@ Control Language="C#" CodeBehind="HomePage.ascx.cs" ClassName="HomePage" Inherits="Exercise2Solution.Module.Web.HomePage" %>
<%@ Register Assembly="DevExpress.Web.v16.2, Version=16.2.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
